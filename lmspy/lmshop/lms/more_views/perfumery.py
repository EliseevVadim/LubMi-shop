    ...
    def get(request, *_, **__):
        return render(request, 'lms/perfumery.html', {
            ...
            'topics': {
                ...
                "Парфюмерные термины":
                    """**Абсолют** (также **абсолю**) — смесь веществ, извлечённых из помады или конкрета. Чаще всего абсолют извлекают 
                    ...
                    чем эфирные масла.\n\n**Концентрат** – парфюмерная композиция, которую составили по правильной формуле, но не соединили 
                    с растворителем. Доля концентрата в растворяющем носителе называется концентрацией аромата.\n\n**Гамма аромата** – 
                    определение звучания и характера парфюма. Чаще всего выделяют теплую и холодную гамму. Первая, соответственно, 
                    ...
                    \n\n**Композиция** – смесь ароматических или душистых компонентов любого качества, созданная в соответствии с задумкой 
                    своего автора.\n\n**Ольфакторный** – определение восприятия запахов. Например, ольфакторная память – память запахов; 
                    ольфакторная пирамида – состав аромата.\n\n**Аносмия** – потеря обоняния или невосприимчивость к запахам. Может быть полной
                    ...
                    особенностях организма).\n\n**Макросмия** – повышенная чувствительность к запахам. Бывает полной или частичной. В первом 
                    ...
                    знаковые, легендарные ароматы прошлых годов. Это нашумевшие и очень популярные духи предыдущих поколений, которые и в 
                    ...
                    1950-х годов.\n\n**Распив** – совместное приобретение парфюма несколькими людьми с целью его последующего деления. При этом, 
                    ...
                    \n\n**Атомайзер** (**отливант**) – специальная емкость небольшого объема (от 1 до 50 мл) для хранения и транспортировки ароматических 
                    жидкостей. Изготавливается из стекла, пластика или металла. Может быть оснащен распылителем. \n\n**Разносить (аромат)** – 
                    тестирование композиции на коже на протяжении нескольких дней в разное время суток, на разных участках тела и при разной 
                    температуре. Делается это для получения целостной и максимально объективной оценки аромата. \n\n**Реплика (аналог, копия)** – более 
                    дешевая копия дорогого аромата.\n\n**Фланкер** – это парфюмерная композиция, созданная в рамках определенной линейки ароматов. 
                    ...
                    издания.\n\n**Блоттер** – прямоугольная бумажная полоска, которую используют в качестве средства для оценки аромата. Такой 
