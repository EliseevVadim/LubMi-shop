{% include "lms/include/dd.js" with name="Dropdown" class="drop-down-list" %}
...
<div class="grid-c6t">
    ...
    <div class="c6t-button-container" style="display: flex; flex-flow: column;">
        ...
        __api_call__('{% url "api:get_customer_info" flags=15 %}', null, answer => {
            ...
            const sb_show_enabler = () => {
                let ready = c6t_dialog.ready();
                return ready && ready.value == 'yes';
            }
            ...
            _street.dd = new Dropdown(_street, "c6t-dd-street", streets_updater, sb_show_enabler, () => _building.dd.update());
            _building.dd = new Dropdown(_building, "c6t-dd-building", buildings_updater, sb_show_enabler);
