...
urlpatterns = [
    ...
    path('admin/action/customers/', Admin_Customers_View.as_view(), name='admin_action_customers'),
    path('admin/action/notifications/', Admin_Notifications_View.as_view(), name='admin_action_notifications'),
    # -- backstage --
